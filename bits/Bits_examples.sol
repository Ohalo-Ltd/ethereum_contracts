...
contract BitsExamples {
    ...
    // Set bits
    function setBitExample() public pure returns (bool){
        uint n = 0;
    ...
    // Clear bits
    function clearBitExample() public pure returns (bool){
        uint n = 15;       // 1111
    ...
    // Toggle bits
    function toggleBitExample() public pure returns (bool){
        uint n = 9;         // 1001
    ...
    function bitExample() public pure returns (bool){
        uint n = 9; // 1001
        assert(n.bit(0) == 1);
        assert(n.bit(1) == 0);
        assert(n.bit(2) == 0);
    ...
    // Is a bit set
    function bitSetExample() public pure returns (bool){
        uint n = 9; // 1001
    ...
    // Are bits equal
    function bitEqualExample() public pure returns (bool){
        uint n = 9; // 1001
        uint m = 3; // 0011
    ...
    // Bit 'not'
    function bitNotExample() public pure returns (bool){
        uint n = 9; // 1001
        assert(n.bitNot(0) == 0);
        assert(n.bitNot(1) == 1);
        assert(n.bitNot(2) == 1);
    ...
    // Bits 'and'
    function bitAndExample() public pure returns (bool){
        uint n = 9; // 1001
        uint m = 3; // 0011
    ...
    // Bits 'or'
    function bitOrExample() public pure returns (bool){
        uint n = 9; // 1001
        uint m = 3; // 0011
    ...
    // Bits 'xor'
    function bitXorExample() public pure returns (bool){
        uint n = 9; // 1001
        uint m = 3; // 0011
    ...
    // Get bits
    function bitsExample() public pure returns (bool){
        uint n = 13;                // 0 ... 01101
    ...
    function bitsExampleThrowsZeroBitNumber() public pure returns (bool){
        uint n = 13;
    ...
    // Highest bit set
    function highestBitSetExample() public pure returns (bool){
        uint n = 13;                    // 0 ... 01101
    ...
    // Highest bit set
    function lowestBitSetExample() public pure returns (bool){
        uint n = 12;                    // 0 ... 01100
